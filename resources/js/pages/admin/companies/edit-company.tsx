...
export default function EditCompany({ organizations, company }: any) {
...
const defaultOrganization = optionsOrganization?.filter((o: any) => o.value == company?.organization_id).map((opt: any) => ({ value: opt.value, label: opt.label }));
